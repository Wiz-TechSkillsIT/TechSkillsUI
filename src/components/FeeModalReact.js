    ...
    <div style={overlayStyle} onClick={handleOverlayClick}>
      <div style={modalStyle}>
        ...
        <div style={feeCardStyle}>
          <h3 style={levelStyle}>Level 1: React Essentials: Building the Foundation</h3>
          <p style={feeStyle}>Free -  Recorded Videos</p>
        </div>

        <div style={feeCardStyle}>
          <h3 style={levelStyle}>Level 2: Advanced React Development: Real-World Applications</h3>
          <p style={feeStyle}>Rs. 4500</p>
          <p style={descriptionStyle}>
            This is a completely hands-on online Zoom-based course. The total duration is 30-35 hours of live training, and the course lasts 4 to 6 weeks. Sessions are conducted after 6:30 PM on weekdays and in the morning on weekends.
            <br />
