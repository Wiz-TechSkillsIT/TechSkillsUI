    ...
    <div style={overlayStyle} onClick={handleOverlayClick}>
      <div style={modalStyle}>
        ...
        <div style={feeCardStyle}>
          <h3 style={levelStyle}>Level 1: Node Fundamentals with CRUD APIs</h3>
          <p style={feeStyle}>Free -  Recorded Videos</p>
        </div>

        <div style={feeCardStyle}>
          <h3 style={levelStyle}>Level 2: Professional Node.js API Development</h3>
          <p style={feeStyle}>Rs. 4000</p>
          ...
          <button style={enrollButtonStyle} onClick={()=>enroll('671e91552449134eeecffcf7','level2')}>Enroll in Level 2</button>
        </div>

        <div style={feeCardStyle}>
          <h3 style={levelStyle}>Level 3: Advanced Node.js Developments with Microservices</h3>
          <p style={feeStyle}>Rs. 6000</p>
          <p style={descriptionStyle}>
            This course builds on Level 2 and focuses on advanced backend development and microservices and scaling. The total duration is 30-35 hours of live Zoom training, conducted over 5 to 7 weeks. Sessions are also held after 6:30 PM on weekdays and on weekends in the morning.
            <br />
          ...
          <button style={enrollButtonStyle} onClick={()=>enroll('671e91552449134eeecffcf7','level3')}>Enroll in Level 3</button>
        </div>
